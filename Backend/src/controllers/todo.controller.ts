...
export const getCustomerRequestsForWeekController = async (req: Request, res: Response) => {
    ...
    try {
        const weekData = await getCustomerRequestsForWeek(companyId, startDate, endDate);
