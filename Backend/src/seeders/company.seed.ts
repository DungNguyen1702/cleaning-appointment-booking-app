...
export async function seedCompanies() {
  ...
  for (let i = 14; i <= 60; i++) {
    ...
    company.address_tinh = provinces[i % provinces.length];
...
export async function updateCompanyImage() {
  ...
  for (const company of companies) {
    company.image4 =
      'https://top10tphcm.com/wp-content/uploads/2019/09/top-dich-vu-don-dep-nha-cua-tot-nhat-tai-binh-duong.jpg';
    company.image5 =
      'https://lh3.googleusercontent.com/proxy/YxU9lyWQbECF-wbtJlFsAeJIDdc3EarX926azPuyGk8IlcdTJuokYmIhekLExbI9MJL1WyrkxAjot6uoToP6YzCpqsZ0Dnf061AWYRCDBAh6f-dRfnATwtztekLVA-YaQVY';
